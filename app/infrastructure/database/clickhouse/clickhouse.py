...
from app.infrastructure.database.clickhouse.sqls import CREATE_REPOSITORIES_DATABASE, CREATE_REPOSITORIES_TABLES_SQL_QUERIES, DROP_REPOSITORIES_DROP_TABLES
...
class ClickHouseDataBase(BaseDataBase):
    ...
    async def drop_tables(self) -> None:
        try:
            ...
            self.logger.info(f"Таблицы успешно очищены")
        except Exception as e:
